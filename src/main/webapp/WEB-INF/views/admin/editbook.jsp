...
<div id="bodyPan">
  <div id="bodyLeftPan">
	...
	<p>Enter your updated details and then press submit....</p>
	<form action="books.html?id=${editbook.id}" method="post">
			Author:<input name="author" type="text" size="60" value="${editbook.author}"></input><br></br>
			Title:<input name="title" type="text" size="60" value="${editbook.title}"></input><br></br>
			Year:<input name="year" type="text" size="60" value="${editbook.year}" ></input><br></br>
			Description:<input name="description" type="text" size="60" value="${editbook.description}" ></input><br></br>
			Category:<input name="category" type="text" size="60" value="${editbook.category}" ></input><br></br>
			<input type="submit"></input>
			<input name="available" value="${editbook.available}" type="hidden" ></input><br></br>
			<input name="checkoutuser"  value="${editbook.checkoutuser}" type="hidden"  ></input><br></br>
